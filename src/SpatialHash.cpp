...
SpatialHash::SpatialHash(float cellSize, float smoothing_dist, uint32_t tableSize)
    : m_cellSize(cellSize), m_tableSize(tableSize), m_particleTable(nullptr), h(smoothing_dist) {}
